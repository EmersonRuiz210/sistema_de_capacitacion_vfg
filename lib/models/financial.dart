...
class FinancialTopic {
  ...
  /// Esta es la información extraída de la guía del asesor VFG
  static List<FinancialTopic> getTopics() {
    return [
      FinancialTopic(
        ...
        description:
        'Guardar una parte de lo que recibes para emergencias o metas. No importa la cantidad, importa la constancia.',
        keyPoints: [
        ...
        example:
        'Doña Rosa ahorró Q5 diarios, en 6 meses juntó Q900 y compró una olla más grande para su negocio de atol. Ahora gana más.',
      ...
      FinancialTopic(
        ...
        description:
        'Dinero que recibes hoy y devuelves en cuotas con un pequeño costo (interés).',
        keyPoints: [
        ...
        example:
        'Esperanza pidió préstamo para su siembra, pero su familia la presionó para comprar televisor y moto. Pidió más préstamos y no pudo pagar.',
      ...
      FinancialTopic(
        ...
        description:
        'Es el costo que pagas por usar dinero prestado. También puede ser lo que ganas cuando prestas tu dinero.',
        keyPoints: [
        ...
        example:
        'Pedro pagó Q100 de interés por un préstamo de Q1,000 en 6 meses. Eso es el 10% de interés.',
      ...
      FinancialTopic(
        ...
        description:
        'Planifica cómo vas a usar tu dinero cada mes. Saber cuánto entra y cuánto sale es clave.',
        keyPoints: [
        ...
        example:
        'María anotó todos sus gastos por una semana. Descubrió que gastaba Q50 diarios en comida. Ajustó su presupuesto y ahorró Q200 a la semana.',
